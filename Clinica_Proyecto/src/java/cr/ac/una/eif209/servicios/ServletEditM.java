 ...
 * @author Admin
 */
@WebServlet(name = "ServletEditM", urlPatterns = {"/ServletEditM"})
public class ServletEditM extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String insertStr = "update medico set id_especialidad=? where cedula=?";

            try (Connection cnx = db.getConnection();
                PreparedStatement myInsert = cnx.prepareStatement(insertStr)) {
                myInsert.setString(1, request.getParameter("especialidad"));
                myInsert.setString(2, request.getParameter("cedula"));
