 ...
 * @author Admin
 */
@WebServlet(name = "ServletAgregarA", urlPatterns = {"/ServletAgregarA"})
public class ServletAgregarA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String insertStr = "insert into administrador (cedula,nombre,apellido,clave)"+" VALUES(?,?,?,?);";
