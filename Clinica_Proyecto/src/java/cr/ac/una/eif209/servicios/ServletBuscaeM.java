 ...
 * @author Admin
 */
@WebServlet(name = "ServletBuscaeM", urlPatterns = {"/ServletBuscaeM"})
public class ServletBuscaeM extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
            ...
            String insertStr = "select * from medico c where cedula=?";
    ...
    public Medico from(ResultSet rs, String alias){
        try {
            ...
            c.setFrecuenciaCita(rs.getInt(alias+".FrecuenciaCita"));
            return c;
        } catch (SQLException ex) {
            return null;
        }
