 ...
 * @author Admin
 */
@WebServlet(name = "ServletLoginM", urlPatterns = {"/ServletLoginM"})
public class ServletLoginM extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
            ...
            String insertStr = "select * from medico c where cedula=? and clave=?";
