 ...
 * @author ariqq
 */
@WebServlet(name = "ServletBuscarCita", urlPatterns = {"/ServletBuscarCita"})
public class ServletBuscarCita extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String insertStr = "select * from cita c where id_Medico=? and estado=?";
            ...
            RequestDispatcher a = request.getRequestDispatcher("CrearCita.jsp");
